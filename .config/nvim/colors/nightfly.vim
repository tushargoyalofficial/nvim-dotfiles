...
" Functions
exec 'highlight Function guifg=' . s:blue . ' gui=italic'

" Strings
highlight! link String NightflyTan

" Booleans
exec 'highlight Boolean guifg=' . s:watermelon . ' gui=italic'

" Identifiers
exec 'highlight Identifier guifg=' . s:turquoise . ' gui=italic'

" Color of titles
exec 'highlight Title guifg=' . s:orange . ' gui=italic'

" const, static
exec 'highlight StorageClass guifg=' . s:orange . ' gui=italic'

" void, intptr_t
exec 'highlight Type guifg=' . s:emerald . ' gui=italic'

" Numbers
highlight! link Constant NightflyOrange

" Character constants
exec 'highlight Character guifg=' . s:purple . 'gui=italic'

" Exceptions
exec 'highlight Exception guifg=' . s:watermelon . 'gui=italic'

" ifdef/endif
highlight! link PreProc NightflyWatermelon

" case in switch statement
exec 'highlight Label guifg=' . s:turquoise . 'gui=italic'
...
exec 'highlight Structure guifg=' . s:indigo . 'gui=italic'
...
exec 'highlight VisualNOS guibg=' . s:regal_blue . ' guifg=fg gui=italic'
